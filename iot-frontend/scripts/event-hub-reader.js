...
class EventHubReader {
  ...
  async startReadMessage(startReadMessageCallback) {
    try {
      console.log('event hub client', EventHubClient);
      const client = await EventHubClient.createFromIotHubConnectionString('HostName=cdv-iot-hub.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=WnGx+UQOfMnHRlwsytwQOLdhTaULPdq9qn7U08qFSmA=');
